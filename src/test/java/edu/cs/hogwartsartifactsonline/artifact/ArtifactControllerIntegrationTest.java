...
//                "Basic " + Base64Utils.encodeToString("john:123456".getBytes())));
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        a.setName("Remember all");
        a.setDescription("A Remember all was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered.");
        ...
        this.mockMvc.perform(post(this.baseUrl + "/artifacts").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, this.token))
                ...
                .andExpect(jsonPath("$.data.name").value("Remember all"))
                .andExpect(jsonPath("$.data.description").value("A Remember all was a magical large marble-sized glass ball that contained smoke which turned red when its owner or user had forgotten something. It turned clear once whatever was forgotten was remembered."))
