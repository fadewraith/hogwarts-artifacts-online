...
import edu.cs.hogwartsartifactsonline.hogwartsuser.UserService;
import edu.cs.hogwartsartifactsonline.wizard.Wizard;
import edu.cs.hogwartsartifactsonline.wizard.WizardRepository;
...
//        coz no wizard owns the dto 6
        ...
        u2.setUsername("eric");
        u2.setPassword("Test@123");
        u2.setEnabled(true);
        u2.setRoles("user");

        HogwartsUser u3 = new HogwartsUser();
        u3.setUsername("tom");
        u3.setPassword("Test@123");
        u3.setEnabled(false);
        u3.setRoles("user");
