...
//    @JsonManagedReference // This side is the "managed" side of the relationship
    ...
    public void addArtifact(Artifact artifact) {
        artifact.setOwner(this); // establishes artifact to wizard
        this.artifacts.add(artifact); // establishes from wizard to artifact
    }
...
//    setting foreign key to null, not deleting the artifact
