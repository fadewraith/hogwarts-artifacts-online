...
import edu.cs.hogwartsartifactsonline.wizard.converter.WizardDtoToWizardConverter;
...
public class WizardController {
    ...
    public Result assignArtifact(@PathVariable("wizardId") Integer wizardId, @PathVariable("artifactId") String artifactId) {
