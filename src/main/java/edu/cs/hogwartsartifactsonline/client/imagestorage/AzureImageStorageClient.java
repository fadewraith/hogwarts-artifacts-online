package edu.cs.hogwartsartifactsonline.client.imagestorage;

import com.azure.storage.blob.BlobClient;
import com.azure.storage.blob.BlobContainerClient;
import com.azure.storage.blob.BlobServiceClient;
import com.azure.storage.blob.models.BlobStorageException;
import edu.cs.hogwartsartifactsonline.system.exception.CustomBlobStorageException;
...
public class AzureImageStorageClient implements ImageStorageClient {
    ...
    //    this blob service client will automatically retrieve the azure blob storage acc name & key & connect to azure blob storage on our behalf
